...
func (c *raftClient) Snapshot(ctx context.Context, in *SnapshotRequest, opts ...grpc.CallOption) (*SnapshotResponse, error) {
	...
	err := grpc.Invoke(ctx, "/proto.Raft/Snapshot", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *raftClient) SnapshotRecovery(ctx context.Context, in *SnapshotRecoveryRequest, opts ...grpc.CallOption) (*SnapshotRecoveryResponse, error) {
	...
	err := grpc.Invoke(ctx, "/proto.Raft/SnapshotRecovery", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Raft_Snapshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(SnapshotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(RaftServer).Snapshot(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Raft_SnapshotRecovery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(SnapshotRecoveryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(RaftServer).SnapshotRecovery(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var fileDescriptor0 = []byte{
	...
	,
}
